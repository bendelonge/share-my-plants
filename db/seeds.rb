...
amayllis2 = Plant.create!(species: 'Amaryllis', city_location: 'Nantes',user: matt, price_per_day: 144, main_picture: File.open(Rails.root.join('db/fixtures/amaryllis.jpg')), description: "Plante à bulbe, cet amaryllis d'intérieur produit une ou plusieurs tiges centralesportant d'énormes fleurs légèrement parfumées superbes en hiver")
